...
const corsService = require('./app/services/corsService');
...
// API documentation generated by JSdoc comments
swaggerService(app);
// Body parser for post & patch request
app.use(corsService);
app.use(express.json());
// Security to avoic XSS attacks
