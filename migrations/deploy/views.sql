...
SELECT "article"."id", "article"."slug", "article"."title", "article"."small_image", "article"."medium_image", "article"."large_image" FROM "article" WHERE "article"."publication_date" <= now() limit 3;
